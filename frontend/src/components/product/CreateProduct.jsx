  ...
  return (
    ...
    >
      ...
      <div className="p-4 md:p-6 bg-white rounded-lg shadow-md">
        ...
        {/* Common Fields */}
        <CommonFieldsForm register={register} name="relatedSku" control={control} setValue={setValue} />
            ...
            <div>
              <div className=" mb-4">
                <div className="p-4 border-l-4 border-blue-500 bg-blue-50 rounded-md space-y-4">
                  ...
                  <div className="mt-6">
                    <h4 className="text-md font-semibold text-yellow-700 mb-2">Related Sku</h4>
                    {variantRelatedSkuFields.map((relatedSku, relatedSkuIndex) => (
                      <div key={relatedSku.id} className="flex gap-4 items-center mb-2">
                        <input
                          {...register(`variants.${index}.relatedSku.${relatedSkuIndex}.sku`)}
                        ...
                        />
                         <input
                          {...register(`variants.${index}.relatedSku.${relatedSkuIndex}.quantity`)}
                          placeholder={`Quantity`}
                          className="flex-1 p-2 border border-yellow-400 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500"
                        />
                        <button
                          type="button"
                          onClick={() => variantRemoveRelatedSku(relatedSkuIndex)}
                    ...
                    <button
                      type="button"
                      onClick={() => variantAppendRelatedSku({ sku: '',quantity:'' })}
                ...
                <div className="p-4 border-l-4 border-yellow-500 bg-yellow-50 rounded-md space-y-4">
                  ...
                  {[
                    ...
                    { label: 'Style', name: `variants.${index}.style.0.value` },
                    {
                  ...
                  <div className="space-y-2">
                    ...
                    >
                     Parent Sku
                      <input
                        {...register(`variants.${index}.child_parent_sku_relationship.0.parent_sku`)}
                        className="mt-1 p-2 border border-yellow-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-400"
                      />
                    </label>
                  </div>
              ...
              <div className="px-4">
                <h4 className="text-md font-semibold text-gray-700">Variant Images</h4>
