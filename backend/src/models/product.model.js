...
const productSchema = new mongoose.Schema({
  ...
  item_length: { type: [mongoose.Schema.Types.Mixed], default: [], },
  item_weight: { type: [mongoose.Schema.Types.Mixed], default: [], },
  item_type_name: { type: [mongoose.Schema.Types.Mixed], default: [], },
  clasp_type: { type: [mongoose.Schema.Types.Mixed], default: [], },
